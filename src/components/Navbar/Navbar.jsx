...
export default function NavBar() {
  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 tech-grid ${
        scrolled 
          ? 'bg-gray-900/95 backdrop-blur-md shadow-lg shadow-accentBlue/5 border-b border-accentBlue/20' 
