...
export default function ActivityCard(props) {
  ...
  function Icon() {
    if (props.title === 'IT Meet') {
      return <MdMonetizationOn className="text-blue-900 w-10 h-10" />
    } else if (props.title === 'Software Freedom Day') {
      return <MdVolunteerActivism className="text-blue-900 w-10 h-10" />
    } else {
      return <GrWorkshop className="text-blue-900 w-10 h-10" />
    }
  }
  return (
