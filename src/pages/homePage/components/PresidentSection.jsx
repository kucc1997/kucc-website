...
export default function PresidentSection() {
  return (
    <div className="flex flex-col p-6 py-14 bg-lightBlue">
      <div className="space-y-6 md:space-y-0 md:space-x-6 lg:space-x-10 xl:space-x-14 md:flex md:items-center mx-auto max-w-screen-xl">
        ...
        <div className="flex-col space-y-3 md:hidden">
          <div>
            <h1 className="text-darkBlue text-xl font-semibold tracking-wide text-center">
              KUCC President
            </h1>
            <h2 className="text-mediumGray text-lg font-medium tracking-wide text-center">
              Nirjal Bhurtel
            </h2>
          </div>
        ...
        <div className="hidden md:flex md:flex-col md:space-y-6 md:items-center">
          <h1 className=" text-darkBlue text-3xl lg:text-4xl font-bold tracking-wider">
            OUR PRESIDENT
          </h1>
        ...
        <div className="hidden md:flex md:flex-col md:space-y-4">
          ...
          <div>
            <h1 className="text-darkBlue text-xl lg:text-2xl font-semibold tracking-wide text-center">
              KUCC President
            </h1>
